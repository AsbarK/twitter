...
export type GetAllTweetsQuery = { __typename?: 'Query', GetAllTweets?: Array<{ __typename?: 'Tweet', id: string, content: string, author?: { __typename?: 'User', profileImageUrl?: string | null, firstName: string, id: string } | null } | null> | null };
